...
const BentoCard = ({
  ...
  >
    ...
    <div className="p-6">
      ...
      <a
        href={href}
        className="mt-6 inline-flex items-center gap-2 opacity-0 translate-y-4 transform-gpu transition-all duration-300 ease-out group-hover:opacity-100 group-hover:translate-y-0 text-blue-600 underline-offset-4 hover:underline"
      >
        {cta}
    ...
    <div className="hidden lg:flex pointer-events-none absolute bottom-0 w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
      <a
        href={href}
        className="inline-flex items-center gap-2 pointer-events-auto text-blue-600 underline-offset-4 hover:underline"
      >
        {cta}
        <ArrowRightIcon className="ms-2 h-4 w-4 rtl:rotate-180" />
      </a>
